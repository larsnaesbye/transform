    ...
    2931: { // Økonomiske nøgletal
        ...
        tableSettings: {
            columnDef: [
                {
                    type: 'txt',
                    fieldId: 'registreringsaktoer',
                    label: 'Registreringsaktør',
                    shortDef: 'Den aktør, der har foretaget registreringen.',
                    longDef: '',
                    defaultWidth: 220
                },
                {
                    ...
                    fieldId: 'sektor',
                    label: 'Sektor',
                    shortDef: 'Forsyningsområde som nøgletal er opgjort for.',
                    longDef: '',
                    defaultWidth: 120
                },
                {
                    ...
                    fieldId: 'aar',
                    label: 'År',
                    shortDef: 'Årstal, som data vedrører. Indberettet af selskabet.',
                    longDef: '',
                    defaultWidth: 100
                },
                {
                    ...
                    fieldId: 'cvrnummer',
                    label: 'CVR',
                    shortDef: 'CVR-nummer for selskabet. Indberettet af selskabet.',
                    longDef: '',
                    defaultWidth: 100
                },
                {
                    type: 'txt',
                    fieldId: 'selskabsnavn',
                    label: 'Selskab',
                    shortDef: 'Selskabets navn. Indberettet af selskabet.',
                    longDef: '',
                    defaultWidth: 300
                },
                {
                    ...
                    fieldId: 'pnummer',
                    label: 'P-nummer',
                    shortDef: 'P-enhedens unikke ID. Indberettet af selskabet.',
                    longDef: '',
                    defaultWidth: 120
                },
                {
                    ...
                    unit: 'DKK',
                    defaultWidth: 180,
                    shortDef: 'Dette nøgletal angiver den estimerede pris per leveret forsyningsenhed. Nøgletallet angives i løbende priser givet ved året for den økonomiske ramme.',
                ...
                },
                {
                    ...
                    decimals: 0,
                    separator: true,
                    fieldId: 'leveret_forsyningsmaengde',
                    label: 'Leveret forsyningsmængde',
                    defaultWidth: 200,
                    shortDef: 'Dette nøgletal dækker over den leverede forsyningsmængde angivet i den for det pågældende forsyningsområdes relevante enhed. Indberettet af selskabet.',
                    longDef: 'ELNET<br />For elnetvirksomheder angiver nøgletallet antal kWh leveret af elnetvirksomheden til slutbruger eller anden aftager, jf. § 2, nr. 11 i indtægtsrammebekendtgørelsen.<br /><br />VAND<br />For vand angiver nøgletallet den debiterede vandmængde målt i kubikmeter (m<sup>3</sup>) per år. Det indebærer det antal kubikmeter, som vandselskabet leverer, afleder, indvinder, transporterer, behandler mv. mod betaling per år, jf. ØR-bekendtgørelsens § 1, stk. 2.'
                },
                {
                    type: 'txt',
                    fieldId: 'enhed',
                    label: 'Enhed',
                    defaultWidth: 150,
                    shortDef: 'Enhed for feltet "leveret forsyningsmængde"',
                    longDef: ''
                },
                {
                    type: 'num',
                    decimals: 0,
                    separator: true,
                    fieldId: 'oekonomiskramme',
                    unit: 'DKK',
                    label: 'Økonomisk ramme',
                    defaultWidth: 150,
                    shortDef: 'Økonomisk ramme er en fælles betegnelse for de etårige indtægtsrammer og regnskabsmæssige kontrolrammer, der fastsættes på hvert forsyningsområde. Nøgletallet angives i løbende priser givet ved året for den økonomiske ramme.',
                ...
                },
                {
                    ...
                    decimals: 0,
                    separator: true,
                    fieldId: 'forrentningsramme',
                    unit: 'DKK',
                    label: 'Forrentningsramme',
                    defaultWidth: 210,
                    shortDef: 'Forrentningsrammen udgør forrentningen af et forsyningsselskabs historiske forrentningsgrundlag og fremadrettede forrentningsgrundlag med tilhørende forskellige forrentningssatser. Angives i løbende priser givet ved året for den økonomiske ramme.',
                ...
                },
                {
                    ...
                    decimals: 0,
                    separator: true,
                    fieldId: 'omkostningsramme',
                    unit: 'DKK',
                    label: 'Omkostningsramme',
                    defaultWidth: 210,
                    shortDef: 'Omkostningsrammen er fastsat med udgangspunkt i forsyningsselskabets gennemsnitlige omkostninger. Nøgletallet angives i løbende priser givet ved året for den økonomiske ramme.',
                ...
                },
                {
                    ...
                    label: 'Tillæg',
                    defaultWidth: 150,
                    shortDef: 'Dette nøgletal dækker over tillæg til omkostningsrammen, som selskaberne kan ansøge om. Angives i løbende priser givet ved året for den økonomiske ramme.',
                ...
                },
                {
                    ...
                    decimals: 0,
                    separator: true,
                    fieldId: 'generelt_effektivitetskrav',
                    unit: 'DKK',
                    label: 'Generelt effektiviseringskrav (DKK)',
                    defaultWidth: 220,
                ...
                },
                {
                    ...
                    decimals: 0,
                    separator: true,
                    fieldId: 'ikke_paavirkelige_omkostninger',
                    unit: 'DKK',
                    label: 'Ikke-påvirkelige omkostninger',
                    defaultWidth: 220,
                ...
                {
                    type: 'txt',
                    fieldId: 'selskabsfusion',
                    label: 'Selskabsfusion',
                    defaultWidth: 175,
                    shortDef: 'Selskabsfusion angiver ved de impliceredes CVR-numre, om selskabet i det pågældende år er fusioneret med et eller flere andre selskaber. Indberettet af selskabet.',
                ...
                {
                    type: 'txt',
                    fieldId: 'selskabsspaltning',
                    label: 'Selskabsspaltning',
                    defaultWidth: 200,
                    shortDef: 'Selskabsspaltning angiver ved de impliceredes CVR-numre, om selskabet i det pågældende år er spaltet til et eller flere selskaber. Indberettet af selskabet.',
